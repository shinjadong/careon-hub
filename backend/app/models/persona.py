...
class PersonaResponse(PersonaBase):
    ...
    successful_sessions: int = Field(default=0, description="성공한 세션 수")
    failed_sessions: int = Field(default=0, description="실패한 세션 수")
    performance_score: float = Field(default=0.0, description="성능 점수 (0-100)")
